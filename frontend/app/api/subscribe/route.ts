...
export async function POST(request: Request) {
  try {
    ...
    if (normalizedEmail.length > 254) { // RFC 5321 max email length
      return NextResponse.json(
    ...
    const disposableDomains = new Set([
      ...
      '10minutemail.com', '10minutemail.net', '10minute-mail.com', '10minemail.com',
      'guerrillamail.com', 'guerrillamail.net', 'guerrillamail.org', 'guerrillamail.de',
      'mailinator.com', 'mailinator.net', 'mailinator2.com',
      'yopmail.com', 'yopmail.fr', 'yopmail.net',
      'trashmail.com', 'trashmails.com', 'trashmail.net', 'trashmail.ws',
      ...
      'mytemp.email', 'nwldx.com', 'thisisnotmyrealemail.com',
      // Additional common ones
      'anonbox.net', 'binkmail.com', 'bobmail.info', 'bugmenot.com',
      'bumpymail.com', 'burnermail.io', 'chogmail.com', 'dingbone.com',
      'emaildienst.de', 'emailsensei.com', 'emailtemporario.com.br',
      'fakemail.fr', 'fornow.id', 'getairmail.com', 'gmailnator.com',
      'jetable.org', 'jourrapide.com', 'kasmail.com', 'keemail.me',
      'mailforspam.com', 'mailfree.ga', 'mailmetrash.com', 'mailmoat.com',
      'mailnull.com', 'mailslapping.com', 'mailzilla.com', 'mjukglass.nu',
      'moakt.com', 'mohmal.com', 'noclickemail.com', 'nomail.xl.cx',
      'nospam4.us', 'poofy.org', 'pookmail.com', 'privacy.net',
      'quickinbox.com', 'receiveee.com', 'rtrtr.com', 'sbmail.top',
      'slipry.net', 'spam.la', 'spamavert.com', 'spambob.net',
      'spambob.org', 'spambog.com', 'supergreatmail.com', 'teleworm.us',
      'tmailinator.com', 'tmail.com', 'uggsrock.com',
      'upliftnow.com', 'viditag.com', 'viewcastmedia.com', 'wegwerfmail.de'
    ]);
